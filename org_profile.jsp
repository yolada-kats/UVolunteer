    ...
    <body>
        ...
        <ul class="menu">
            <%if(user.getType().equals("Student")){%>
                ...
                <li><a href ="StudentProfile.html" style="text-decoration: none"><button type="button" class="button"></ion-icon><span class="button_icon"><ion-icon name="person-outline"></ion-icon></span><span class="button_text">Profile</span></button></li>
