...
<html>
    ...
    <body>
        ...
        <ul class="menu">
            ...
            <li><a href ="favourite.jsp" style="text-decoration: none"><button type="button" class="button"></ion-icon><span class="button_icon"><ion-icon name="star-outline"></span><span class="button_text">Favourites</span></button></a></li>
        ...
        <div class="search-bar">
            ...
            <button type="submit"><a href="searchapp.jsp"><img src="images/search.png"></a></button>
        </div>
        <%User user = (User)session.getAttribute("userObj");
        ApplicationDAO appl = new ApplicationDAO();
        List <Application> applications = appl.listApplications();
        %>
