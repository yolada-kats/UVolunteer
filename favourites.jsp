...
<html>  
    ...
    <body>
        ...
        <li class="active"><a href ="Favorites.html" style="text-decoration: none"><button type="button" class="button"></ion-icon><span class="button_icon"><ion-icon name="star-outline"></span><span class="button_text">Favourites</span></button></a></li>
                ...
                <div class="flex-container">
                    <div class="flex-box">
                        ...
                        <div class="info-icons">
                            <button class="info" type="button" disabled> <ion-icon name="compass-outline"></ion-icon> Athens</button>
                            <button class="info" type="button" disabled> <ion-icon name="calendar-outline"></ion-icon> 8/1/24</button>
                        </div>
                        <div class="info-buttons">
                            <button class="application" type="submit">Click here to visit</button>
